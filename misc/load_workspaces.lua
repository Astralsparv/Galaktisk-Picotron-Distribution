--[[pod_format="raw",created="2025-12-14 18:52:15",modified="2025-12-14 19:07:26",revision=4]]
...
if stat(317) > 0 then 
	...
	if (sdat.taskbar) then
		create_process("/system/extras/taskbar.p64")
	end
	
	if (sdat.playtime_tracker) then
		create_process("/system/extras/playtimeTracker.p64")
	end
	...
	if (sdat.autoboot_springloader) then
		create_process("/system/packaged/springloader.p64")
	end
end
