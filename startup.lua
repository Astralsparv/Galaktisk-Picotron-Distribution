...
if (sdat.taskbar == nil) then
	sdat.taskbar = true
	store("/appdata/system/settings.pod", sdat)
end

if (sdat.playtime_tracker == nil) then
	sdat.playtime_tracker = true
	store("/appdata/system/settings.pod", sdat)
end

if (sdat.autoboot_springloader == nil) then
	sdat.autoboot_springloader = false
	store("/appdata/system/settings.pod", sdat)
end
